package com.mkkcreations.portfolio_server.api.jwt;
...
public class JwtHelper {
    ...
    public JwtHelper(@org.springframework.beans.factory.annotation.Value("${accessTokenSecret}") String accessTokenSecret, @org.springframework.beans.factory.annotation.Value("${refreshTokenSecret}") String refreshTokenSecret, @org.springframework.beans.factory.annotation.Value("${com.example.demo.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @org.springframework.beans.factory.annotation.Value("${com.example.demo.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
